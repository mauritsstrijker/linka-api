...
namespace Linka.Application.Features.Volunteers.Queries
{
    ...
    public sealed record GetVolunteerByIdResponse(Guid UserId, string Name, string Surname, string FullName, string Username, AddressDto Address, int ConnectionsCount, string? ProfilePictureBase64, string? ProfilePictureExtension, string Email, int AllTimePoints, int Points);
